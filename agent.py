...
class CSPAgent():
    ...
    def _check_equations_for_mine_and_non_mine_variables(self):
        ...
        for equation in self.all_constraint_equations.copy():
            ...
            # If the equation becomes empty. all its variables are removed
            ...
            if equation[1] == 0:
                ...
                for non_mine_variable in equation[0]:
                    if not self.env.opened[non_mine_variable.row, non_mine_variable.column] and non_mine_variable not in self.non_mine_variables:
